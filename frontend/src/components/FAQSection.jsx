...
export function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      description: "Connect with other Sryzen users in our Discord server. Get quick help via public support or chat with our community."
    }
  ];
  ...
  return (
    <div className="space-y-6 mt-12">
      ...
      >
        ...
        {/* Gradient overlay */}
        {!expanded && (
          <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-[#080a0b] to-transparent pointer-events-none" />
        )}
      </div>
