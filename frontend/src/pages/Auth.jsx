...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#08090c] p-4">
      {/* Toast notification */}
      ...
      <div className="mb-10">
        <img
          src="https://i.imgur.com/C8Vv6IO.png"
          alt="Sryzen"
      ...
      <footer className="w-full py-8 px-4 mt-10">
        <div className="max-w-md mx-auto text-center">
          <p className="text-sm text-[#95a1ad]">
            © {new Date().getFullYear()} Sryzen. All rights reserved.
          </p>
          <p className="text-xs text-[#95a1ad]/70 mt-0.5">
            Powered by Heliactyl Next 10 (Toledo)<br />Designed, developed and built by Ether
          </p>
        </div>
      </footer>
    </div>
